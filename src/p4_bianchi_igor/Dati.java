...
public class Dati{
    ...
    //GOOGLEstore
	//Overview
	private ArrayList<String> overview_data;//anche win store
	...
	private ArrayList<String> country_data;//win store
	...
	private ArrayList<String> osVersion_data;//win store
    ...
    private double count_new;//stampare solo questi
    private double count_revised;//stampare solo questo
