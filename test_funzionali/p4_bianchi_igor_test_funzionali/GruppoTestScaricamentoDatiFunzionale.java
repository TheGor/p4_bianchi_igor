...
public class GruppoTestScaricamentoDatiFunzionale 
{

	//testo la funzione di scaricamento dei dati di un gruppo, 
	...
	@Test
	public void testScaricamentoDatiGruppoFunzionale()
	{
		//creo dati da associare alle app e al gruppo
		//classe dati completa
		Gruppo gruppoFunc1=new Gruppo("gruppoFunc1");
		Dati datiAggregati=new Dati();
		Dati d=new Dati();
	
		ElementAppStore store1=new GoogleStore();
		App app10Func=new App("func10",store1);
		App app20Func=new App("func20",store1);
		...
		listApp.add(app10Func);
		listApp.add(app20Func);
		gruppoFunc1.setApps(listApp);
		for(int i=0;i<gruppoFunc1.getApps().size();i++)
		{
			//overview
			...
			d.setPackage_name_overview(gruppoFunc1.getApps().get(i).getNomeApp());
			d.setDaily_average_overview(daily2);
			d.setTotal_average_overview(daily2);
			
			//carrier
			d.setData_carrier(date);
			d.setPackage_name_carrier(gruppoFunc1.getApps().get(i).getNomeApp());
			...
			d.setPackage_name_country(gruppoFunc1.getApps().get(i).getNomeApp());
			...
			d.setPackage_name_device(gruppoFunc1.getApps().get(i).getNomeApp());
			d.setDevice(device);
			...
			d.setPackage_name_language(gruppoFunc1.getApps().get(i).getNomeApp());
			...
			d.setPackage_name_os_version(gruppoFunc1.getApps().get(i).getNomeApp());
			...
			d.setPackage_name_tablet(gruppoFunc1.getApps().get(i).getNomeApp());
			...
			d.setPackage_name_app_version(gruppoFunc1.getApps().get(i).getNomeApp());
		...
		gruppoFunc1.setDatiAggregati(datiAggregati);
		
		String s1=gruppoFunc1.preparazioneDatiStringa();
		String percorsoNome="/home/se-17-user/fileTestFunc";
		assertTrue(gruppoFunc1.salvataggioFile(percorsoNome, s1));
